...
import org.compilers.automaton_io.automaton_reader.FiniteAutomatonReaderImpl;
...
public final class CommandLineInterface implements UserInterface {
    ...
    private CommandLineInterface() throws IOException {
        this.finiteAutomaton = FiniteAutomatonReaderImpl.instance().read(Configuration.FINITE_AUTOMATON_DEFINITION_FILE);
    }
